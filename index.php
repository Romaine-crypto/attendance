...
?>
    ...
    <h1 class="text-center" >Registration for IT Conference</h1>
        ...
        <form method="post" action ="success.php">
            <div class="form-row">
                ...
                <div class="custom-file">
                        ...
                        <small id="avatar" class="form-text text-yellow"> File uploading is Optional</small>
        ...
        <br>
        <button type="Register" name="Register" class="btn btn-primary btn-block">Register</button>
